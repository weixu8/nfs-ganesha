                                         ...
                                         fsal_attrib_list_t * pattr)     /* IN */
{
  ...
  fsal_status = FSAL_test_access_default(pcontext, (FSAL_W_OK | FSAL_X_OK), pattr);
  if(FSAL_IS_ERROR(fsal_status))
...
fsal_status_t FSAL_merge_attrs_default(fsal_attrib_list_t * pinit_attr,
