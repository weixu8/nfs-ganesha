 ...
 */
fsal_status_t ASYNCMFSL_test_access(fsal_op_context_t * p_context, /* IN */
 ...
 */
fsal_status_t ASYNCMFSL_setattr_access(fsal_op_context_t * p_context,      /* IN */
...
fsal_status_t ASYNCMFSL_rename_access(fsal_op_context_t * pcontext,        /* IN */
                                      fsal_attrib_list_t * pattrsrc,    /* IN */
                                      fsal_attrib_list_t * pattrdest)   /* IN */
{
  fsal_status_t fsal_status;

  fsal_status = ASYNCMFSL_test_access(pcontext, FSAL_W_OK, pattrsrc);
  if(FSAL_IS_ERROR(fsal_status))
    Return(fsal_status.major, fsal_status.minor, INDEX_FSAL_rename_access);

  fsal_status = ASYNCMFSL_test_access(pcontext, FSAL_W_OK, pattrdest);
  if(FSAL_IS_ERROR(fsal_status))
    Return(fsal_status.major, fsal_status.minor, INDEX_FSAL_rename_access);
 ...
 *        - ERR_FSAL_SERVERFAULT  (unexpected error)
 */
fsal_status_t ASYNCMFSL_create_access(fsal_op_context_t * pcontext,        /* IN */
                                      fsal_attrib_list_t * pattr)       /* IN */
{
  fsal_status_t fsal_status;

  fsal_status = ASYNCMFSL_test_access(pcontext, FSAL_W_OK, pattr);
  if(FSAL_IS_ERROR(fsal_status))
 ...
 *        - ERR_FSAL_SERVERFAULT  (unexpected error)
 */
fsal_status_t ASYNCMFSL_unlink_access(fsal_op_context_t * pcontext,        /* IN */
                                      fsal_attrib_list_t * pattr)       /* IN */
{
  fsal_status_t fsal_status;
...
fsal_status_t ASYNCMFSL_link_access(fsal_op_context_t * pcontext,  /* IN */
                                    fsal_attrib_list_t * pattr) /* IN */
{
  fsal_status_t fsal_status;
...
fsal_status_t ASYNCMFSL_merge_attrs(fsal_attrib_list_t * pinit_attr,
